...
from policies.surv.algorithms.algo_ADD4 import MultiRobotPathPlanner
...
cases = [
    MultiRobotPathPlanner(10, 10, False, [1, 3, 9], [0.2, 0.3, 0.5], [], False),
    MultiRobotPathPlanner(
        20, 20, False, [1, 50, 76, 83], [0.2, 0.3, 0.5], [3, 4, 5, 6, 7, 8, 99, 100, 101, 102], False
    ),
    MultiRobotPathPlanner(50, 50, False, [1, 2, 3, 4], [0.2, 0.3, 0.5], [], False),
    MultiRobotPathPlanner(
        50,
        50,
        False,
...
@parameterized_class(("multiRobot", "case"), [(cases[0], 1), (cases[1], 2), (cases[2], 3), (cases[3], 4)])
